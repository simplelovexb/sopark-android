...
import cn.suxiangbao.sosark.view.FeatureView;
 ...
 * @文件名称: DemoStartActivity.java
 * @类型名称: DemoStartActivity
 */
public class DemoStartActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_demostart);
		/**
