package cn.suxiangbao.sosark.pic.fragment.basic;
...
public abstract class BaseFragment extends Fragment {
    ...
    protected PictureSelectFragment.OnPictureSelectedListener mListener;
	/** 类标签 */
...
//		LogUtils.i(getFragmentName() + " onDetach()");
    ...
    public void setActivityListener(PictureSelectFragment.OnPictureSelectedListener listener){
